...
import { ArrowLeft, Users, FileText, TrendingUp, Award, Eye, Gift } from 'lucide-react';
...
type TaskScene = 'follow' | 'engagement' | 'seeding' | 'engagement_reward';
...
const TASK_DATA: Record<string, TaskData> = {
  '1': {
    ...
    prizeIssueDetails: [
      { id: 'p001', avatar: '🌸', userName: '小鹿Elaine', phone: '138****1623', prizeType: '积分', prizeName: '50星云币', prizeImage: '/prizes/points-50.png', issuedAt: '2026-04-17 10:22', status: '已领取' },
      { id: 'p002', avatar: '🎵', userName: 'Tony的日常', phone: '139****8831', prizeType: '积分', prizeName: '50星云币', prizeImage: '/prizes/points-50.png', issuedAt: '2026-04-17 10:22', status: '已领取' },
      { id: 'p003', avatar: '🍃', userName: 'Lina晴天', phone: '137****4796', prizeType: '积分', prizeName: '50星云币', prizeImage: '/prizes/points-50.png', issuedAt: '—', status: '未领取' },
      { id: 'p004', avatar: '🧢', userName: '阿诺测评', phone: '136****4059', prizeType: '赠品', prizeName: '品牌联名帆布包', prizeImage: '/prizes/gift-bag.png', issuedAt: '2026-04-18 16:20', status: '已领取' },
      { id: 'p005', avatar: '🍓', userName: 'Momo爱分享', phone: '135****9082', prizeType: '现金红包', prizeName: '20元现金红包', prizeImage: '/prizes/red-packet-20.png', issuedAt: '—', status: '未领取' },
      { id: 'p006', avatar: '🌊', userName: '南风Vlog', phone: '132****6615', prizeType: '现金红包', prizeName: '10元现金红包', prizeImage: '/prizes/red-packet-10.png', issuedAt: '2026-04-18 20:45', status: '已领取' },
      { id: 'p007', avatar: '🦊', userName: '阿橘同学', phone: '136****5521', prizeType: '抽奖机会', prizeName: '幸运转盘抽奖x1', prizeImage: '/prizes/lottery-1.png', issuedAt: '2026-04-18 09:13', status: '已领取' },
      { id: 'p008', avatar: '🍋', userName: '柠檬汽水', phone: '135****7433', prizeType: '赠品', prizeName: '联名保温杯', prizeImage: '/prizes/gift-cup.png', issuedAt: '—', status: '未领取' },
      { id: 'p009', avatar: '🎀', userName: 'Yoyo酱', phone: '134****9287', prizeType: '现金红包', prizeName: '25元现金红包', prizeImage: '/prizes/red-packet-25.png', issuedAt: '2026-04-18 11:56', status: '已领取' },
      { id: 'p010', avatar: '🧃', userName: '可可早安', phone: '133****4408', prizeType: '积分', prizeName: '80星云币', prizeImage: '/prizes/points-80.png', issuedAt: '2026-04-18 12:20', status: '已领取' },
      { id: 'p011', avatar: '🌼', userName: '木木日记', phone: '132****7912', prizeType: '抽奖机会', prizeName: '幸运转盘抽奖x2', prizeImage: '/prizes/lottery-2.png', issuedAt: '—', status: '未领取' },
      { id: 'p012', avatar: '🎬', userName: '镜头里的安安', phone: '131****6645', prizeType: '赠品', prizeName: '新品体验礼盒', prizeImage: '/prizes/gift-box.png', issuedAt: '2026-04-18 15:44', status: '已领取' },
      { id: 'p013', avatar: '🐳', userName: '阿蓝爱生活', phone: '130****2054', prizeType: '积分', prizeName: '20星云币', prizeImage: '/prizes/points-20.png', issuedAt: '—', status: '未领取' },
      { id: 'p014', avatar: '🍑', userName: '桃子酱', phone: '189****3016', prizeType: '现金红包', prizeName: '30元现金红包', prizeImage: '/prizes/red-packet-30.png', issuedAt: '2026-04-18 17:02', status: '已领取' },
      { id: 'p015', avatar: '🪐', userName: '北极星', phone: '188****4720', prizeType: '赠品', prizeName: '定制帆布袋', prizeImage: '/prizes/gift-tote.png', issuedAt: '—', status: '未领取' },
      { id: 'p016', avatar: '☕', userName: 'Morning咖', phone: '187****5589', prizeType: '积分', prizeName: '60星云币', prizeImage: '/prizes/points-60.png', issuedAt: '2026-04-18 19:11', status: '已领取' },
      { id: 'p017', avatar: '🍉', userName: '夏天不迟到', phone: '186****6402', prizeType: '抽奖机会', prizeName: '幸运转盘抽奖x1', prizeImage: '/prizes/lottery-1.png', issuedAt: '—', status: '未领取' },
      { id: 'p018', avatar: '🦄', userName: '软糖星球', phone: '185****7168', prizeType: '赠品', prizeName: 'IP徽章套装', prizeImage: '/prizes/gift-badge.png', issuedAt: '2026-04-18 20:30', status: '已领取' },
      { id: 'p019', avatar: '🌿', userName: '薄荷味的风', phone: '183****2219', prizeType: '积分', prizeName: '100星云币', prizeImage: '/prizes/points-100.png', issuedAt: '2026-04-19 08:45', status: '已领取' },
      { id: 'p020', avatar: '🎨', userName: '画报少女', phone: '182****6673', prizeType: '现金红包', prizeName: '50元现金红包', prizeImage: '/prizes/red-packet-50.png', issuedAt: '2026-04-19 09:12', status: '已领取' },
      { id: 'p021', avatar: '🎻', userName: '大提琴手', phone: '181****4488', prizeType: '赠品', prizeName: '限定款手机壳', prizeImage: '/prizes/gift-phonecase.png', issuedAt: '—', status: '未领取' },
      { id: 'p022', avatar: '🌺', userName: '向日葵女孩', phone: '180****9901', prizeType: '抽奖机会', prizeName: '幸运转盘抽奖x3', prizeImage: '/prizes/lottery-3.png', issuedAt: '2026-04-19 10:30', status: '已领取' },
      { id: 'p023', avatar: '🧊', userName: '冰美式不加糖', phone: '179****3356', prizeType: '积分', prizeName: '120星云币', prizeImage: '/prizes/points-120.png', issuedAt: '—', status: '未领取' },
      { id: 'p024', avatar: '🎡', userName: '摩天轮上的猫', phone: '178****7721', prizeType: '赠品', prizeName: '品牌定制马克杯', prizeImage: '/prizes/gift-mug.png', issuedAt: '2026-04-19 14:08', status: '已领取' },
      { id: 'p025', avatar: '🌶️', userName: '辣椒炒肉', phone: '177****1145', prizeType: '现金红包', prizeName: '8元现金红包', prizeImage: '/prizes/red-packet-8.png', issuedAt: '2026-04-19 15:22', status: '已领取' },
      { id: 'p026', avatar: '🎸', userName: '吉他少年', phone: '176****5590', prizeType: '抽奖机会', prizeName: '幸运转盘抽奖x1', prizeImage: '/prizes/lottery-1.png', issuedAt: '—', status: '未领取' },
      { id: 'p027', avatar: '🌻', userName: '阳光收纳师', phone: '175****8834', prizeType: '积分', prizeName: '30星云币', prizeImage: '/prizes/points-30.png', issuedAt: '2026-04-19 17:55', status: '已领取' },
      { id: 'p028', avatar: '🍰', userName: '甜品猎人', phone: '174****2267', prizeType: '赠品', prizeName: '美妆小样套装', prizeImage: '/prizes/gift-sample.png', issuedAt: '2026-04-19 18:30', status: '已领取' },
      { id: 'p029', avatar: '🛴', userName: '滑板少年阿杰', phone: '173****6612', prizeType: '现金红包', prizeName: '15元现金红包', prizeImage: '/prizes/red-packet-15.png', issuedAt: '—', status: '未领取' },
      { id: 'p030', avatar: '🌊', userName: '海边拾贝人', phone: '172****9945', prizeType: '积分', prizeName: '200星云币', prizeImage: '/prizes/points-200.png', issuedAt: '2026-04-20 09:10', status: '已领取' },
      { id: 'p031', avatar: '🎭', userName: '戏剧社社长', phone: '171****3378', prizeType: '赠品', prizeName: '限量亚克力立牌', prizeImage: '/prizes/gift-acrylic.png', issuedAt: '—', status: '未领取' },
      { id: 'p032', avatar: '🍵', userName: '茶艺小师', phone: '170****7701', prizeType: '抽奖机会', prizeName: '幸运转盘抽奖x5', prizeImage: '/prizes/lottery-5.png', issuedAt: '2026-04-20 11:45', status: '已领取' },
    ],
  },
  '2': {
    id: '2',
    ...
    prizeIssueDetails: [
      { id: 'p021', avatar: '🧁', userName: '奶油可可', phone: '130****5391', prizeType: '积分', prizeName: '50星云币', prizeImage: '/prizes/points-50.png', issuedAt: '2026-04-16 09:11', status: '已领取' },
      { id: 'p022', avatar: '🌈', userName: '彩虹豌豆', phone: '131****2477', prizeType: '赠品', prizeName: '品牌周边礼盒', prizeImage: '/prizes/gift-box.png', issuedAt: '—', status: '未领取' },
    ],
  },
  '3': {
    id: '3',
    ...
    prizeIssueDetails: [
      { id: 'p031', avatar: '🔥', userName: '大头爱摄影', phone: '189****2246', prizeType: '现金红包', prizeName: '10元现金红包', prizeImage: '/prizes/red-packet-10.png', issuedAt: '—', status: '未领取' },
      { id: 'p032', avatar: '⭐', userName: '星星点灯er', phone: '187****3302', prizeType: '积分', prizeName: '30星云币', prizeImage: '/prizes/points-30.png', issuedAt: '2026-04-15 11:20', status: '未领取' },
    ],
  },
  '4': {
    id: '4',
    ...
    prizeIssueDetails: [
      { id: 'p041', avatar: '📺', userName: 'Vivian爱生活', phone: '186****7841', prizeType: '赠品', prizeName: '体验装礼盒', prizeImage: '/prizes/gift-box.png', issuedAt: '—', status: '未领取' },
      { id: 'p042', avatar: '🦋', userName: 'Sophie甜酒', phone: '185****9036', prizeType: '积分', prizeName: '50星云币', prizeImage: '/prizes/points-50.png', issuedAt: '2026-04-16 18:36', status: '已领取' },
    ],
  },
  '5': {
    id: '5',
    ...
    prizeIssueDetails: [
      { id: 'p051', avatar: '👒', userName: '旅行小夏', phone: '139****2012', prizeType: '积分', prizeName: '60星云币', prizeImage: '/prizes/points-60.png', issuedAt: '2026-04-21 09:20', status: '已领取' },
      { id: 'p052', avatar: '🧳', userName: 'Mina在路上', phone: '137****6632', prizeType: '现金红包', prizeName: '20元现金红包', prizeImage: '/prizes/red-packet-20.png', issuedAt: '—', status: '未领取' },
    ],
  },
  '6': {
    id: '6',
    ...
    prizeIssueDetails: [
      { id: 'p061', avatar: '💐', userName: '礼物研究所', phone: '136****7510', prizeType: '赠品', prizeName: '品牌礼盒', prizeImage: '/prizes/gift-box.png', issuedAt: '2026-05-02 11:30', status: '已领取' },
      { id: 'p062', avatar: '🎁', userName: '阿木推荐', phone: '138****9426', prizeType: '积分', prizeName: '80星云币', prizeImage: '/prizes/points-80.png', issuedAt: '—', status: '未领取' },
    ],
  },
  '7': {
    id: '7',
    ...
    prizeIssueDetails: [
      { id: 'p071', avatar: '🪞', userName: '底妆实验室', phone: '135****3250', prizeType: '现金红包', prizeName: '30元现金红包', prizeImage: '/prizes/red-packet-30.png', issuedAt: '2026-04-13 12:01', status: '已领取' },
      { id: 'p072', avatar: '✨', userName: '糖糖美妆', phone: '137****1294', prizeType: '积分', prizeName: '50星云币', prizeImage: '/prizes/points-50.png', issuedAt: '2026-04-13 12:10', status: '已领取' },
    ],
  },
  '8': {
    id: '8',
    ...
    prizeIssueDetails: [
      { id: 'p081', avatar: '🧪', userName: '配方拆解站', phone: '186****2109', prizeType: '积分', prizeName: '120星云币', prizeImage: '/prizes/points-120.png', issuedAt: '2026-03-22 10:35', status: '已领取' },
      { id: 'p082', avatar: '📘', userName: '成分党Leo', phone: '188****8821', prizeType: '积分', prizeName: '30星云币', prizeImage: '/prizes/points-30.png', issuedAt: '—', status: '未领取' },
    ],
  },
  '9': {
    id: '9',
    ...
    prizeIssueDetails: [
      { id: 'p091', avatar: '🛍️', userName: '好物雷达', phone: '130****5832', prizeType: '现金红包', prizeName: '20元现金红包', prizeImage: '/prizes/red-packet-20.png', issuedAt: '2026-05-17 09:40', status: '已领取' },
      { id: 'p092', avatar: '🧾', userName: '精打细算阿七', phone: '132****7955', prizeType: '赠品', prizeName: '优惠券礼包', prizeImage: '/prizes/gift-coupon.png', issuedAt: '—', status: '未领取' },
    ],
  },
  '10': {
    id: '10',
    ...
    prizeIssueDetails: [
      { id: 'p101', avatar: '🫧', userName: '敏感肌阿圆', phone: '139****4602', prizeType: '赠品', prizeName: '修护套装', prizeImage: '/prizes/gift-skincare.png', issuedAt: '2026-04-10 10:15', status: '已领取' },
      { id: 'p102', avatar: '🌙', userName: '夜间修护室', phone: '137****7133', prizeType: '积分', prizeName: '100星云币', prizeImage: '/prizes/points-100.png', issuedAt: '2026-04-10 10:20', status: '已领取' },
    ],
  },
  '11': {
    id: '11',
    ...
    prizeIssueDetails: [
      { id: 'p111', avatar: '🌃', userName: '晚安护肤', phone: '158****6441', prizeType: '积分', prizeName: '40星云币', prizeImage: '/prizes/points-40.png', issuedAt: '2026-03-30 10:05', status: '已领取' },
      { id: 'p112', avatar: '🛏️', userName: '睡前仪式感', phone: '159****1882', prizeType: '现金红包', prizeName: '10元现金红包', prizeImage: '/prizes/red-packet-10.png', issuedAt: '—', status: '未领取' },
    ],
  },
  '12': {
    id: '12',
    ...
    prizeIssueDetails: [
      { id: 'p121', avatar: '🎒', userName: '学生党琳琳', phone: '156****9024', prizeType: '积分', prizeName: '55星云币', prizeImage: '/prizes/points-55.png', issuedAt: '2026-04-04 11:13', status: '已领取' },
      { id: 'p122', avatar: '📚', userName: '寝室测评官', phone: '157****3201', prizeType: '赠品', prizeName: '文具礼包', prizeImage: '/prizes/gift-stationery.png', issuedAt: '—', status: '未领取' },
    ],
  },
};
...
const CLAIM_STATUS_CONFIG: Record<PrizeIssueStatus, { color: string; bg: string; border: string }> = {
  '已领取': { color: 'rgba(82,196,26,1)', bg: 'rgba(82,196,26,0.08)', border: 'rgba(82,196,26,0.25)' },
  '未领取': { color: 'rgba(250,173,20,1)', bg: 'rgba(250,173,20,0.08)', border: 'rgba(250,173,20,0.25)' },
};
    ...
    >
      ...
      <div
        style={{
          ...
          color: clickable && hovered ? '#1d4ed8' : accent,
          lineHeight: 1.2,
...
export function TaskDataDetail() {
  ...
  const isEngagement = data?.scene === 'engagement';
  const [detailTab, setDetailTab] = useState<'participants' | 'prizes'>(isEngagement ? 'prizes' : 'participants');
  ...
  const [prizeStatusFilter, setPrizeStatusFilter] = useState<'all' | PrizeIssueStatus>('all');
  ...
  const filteredPrizeIssues = data.prizeIssueDetails.filter((item) => {
    ...
    const matchStatus = prizeStatusFilter === 'all' || item.status === prizeStatusFilter;
    return matchPhone && matchStatus;
  });
    ...
    <div style={{ padding: '24px' }}>
      ...
      {isEngagement ? (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: '12px', marginBottom: '16px' }}>
          ...
          <KpiCard
            label="奖品发放数量"
            tooltip="活动中累计发放成功的奖品数量。"
            value={String(data.prizeCount)}
            icon={Gift}
            accent="rgba(36,116,255,1)"
          />
        </div>
        ...
        <div style={{ padding: '12px 24px', borderBottom: '1px solid var(--border)', background: 'var(--card)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            ...
            {detailTab === 'participants' ? (
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ fontSize: '12px', color: 'var(--muted-foreground)', whiteSpace: 'nowrap' }}>领取状态：</span>
                <select
                  value={prizeStatusFilter}
                  onChange={(event) => {
                    setPrizeStatusFilter(event.target.value as 'all' | PrizeIssueStatus);
                    setPrizePage(1);
                  }}
                  style={{
                    height: '32px',
        ...
        <div style={{ overflowX: 'auto' }}>
          {detailTab === 'participants' ? (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 'var(--text-base)' }}>
              <thead>
                <tr style={{ background: 'var(--muted)' }}>
                  {['用户昵称', '奖品类型', '奖品信息', '发放时间', '领取状态'].map((h) => (
                    <th
                      key={h}
                      style={{
                        padding: '10px 16px',
              ...
              <tbody>
                {pagedPrizeIssues.map((item, idx) => {
                  const issueStatus = CLAIM_STATUS_CONFIG[item.status];
                  ...
                  return (
                    <tr key={item.id} style={{ borderBottom: isLast ? 'none' : '1px solid var(--border)' }}>
                      ...
                      <td style={{ padding: '12px 16px', whiteSpace: 'nowrap' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <div style={{ width: '32px', height: '32px', borderRadius: '6px', background: 'var(--muted)', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0 }}>
                            <img src={item.prizeImage} alt={item.prizeName} style={{ width: '100%', height: '100%', objectFit: 'cover' }} onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                          </div>
                          <span style={{ color: 'var(--foreground)', fontWeight: 'var(--font-weight-medium)', fontSize: '13px' }}>{item.prizeName}</span>
                        </div>
                      </td>
